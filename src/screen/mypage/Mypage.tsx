...
import SplitBoldLine from '../../components/lines/SplitBoldLine';
    ...
    <SafeContainer style={styles.container}>
      ...
      <View style={styles.subContainer}>
        ...
        <View style={styles.currentContainer}>
          <View style={styles.currentSubContainer1}>
            <Title
              text={'진행중 챌린지'}
              font={FontStyle.regular.font14}
              style={{ marginBottom: 5, color: Color.Gray60 }}
            />
            <Title text={'없음'} font={FontStyle.bold.font18} />
          </View>
          <View style={styles.currentSubContainer2}>
            <Title
              text={'성공한 챌린지'}
              font={FontStyle.regular.font14}
              style={{ marginBottom: 5, color: Color.Gray60 }}
            />
            <Title text={'1'} font={FontStyle.bold.font18} />
          </View>
          <View style={styles.currentSubContainer1}>
            <Title
              text={'남은 챌린지'}
              ...
              style={{ marginBottom: 5, color: Color.Gray60 }}
            />
            <Title text={'65'} font={FontStyle.bold.font18} />
          </View>
        </View>
      </View>
      <Interval height={20} />
...
const styles = StyleSheet.create({
  ...
  currentSubContainer1: {
    flex: 1,
    alignItems: 'center',
  },
  currentSubContainer2: {
    flex: 1,
    alignItems: 'center',
